...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x431B242C, 0x8D1B, 0x497F, {0xAC, 0x69, 0x35, 0x2B, 0xB4, 0x71, 0x35, 0x25}};

GLOBAL_REMOVE_IF_UNREFERENCED GUID gEdkiiDscPlatformGuid = {0xF12E3CB1, 0xC7C0, 0x4EED, {0x9E, 0x78, 0xD1, 0x44, 0xA1, 0xA0, 0x9F, 0x98}};

GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MiniVisorDxe";
...
#define _PCD_VALUE_PcdDebugPrintErrorLevel  0x80400042U
...
{
  return DriverUnload (ImageHandle);
}
